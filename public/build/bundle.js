...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 62, 8, 1129);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(62:6) {#if index === activeQuestion}",
    		ctx
    	});
    ...
    // (61:4) {#each data.results as question, index}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(61:4) {#each data.results as question, index}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(57:15)      Loading....   {:then data}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			info.block.c();
    			add_location(button, file$1, 52, 2, 870);
    			add_location(h30, file$1, 54, 2, 926);
    			add_location(h31, file$1, 55, 2, 955);
    			add_location(div, file$1, 51, 0, 862);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
